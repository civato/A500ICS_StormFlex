...
static struct clk_pll_freq_table tegra_pll_x_freq_table[] = {
    ...
    { 19200000, 1646000000, 943, 11, 1, 8},
	...
	{ 13000000, 1408000000, 864, 8,   1, 12},
	{ 19200000, 1408000000, 878, 12,  1, 8},
...
struct clk tegra_list_periph_clks[] = {
	...
	PERIPH_CLK("2d",	"2d",			NULL,	21,	0x15c,	0x31E,	320000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
	PERIPH_CLK("epp",	"epp",			NULL,	19,	0x16c,	0x31E,	425000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
	PERIPH_CLK("mpe",	"mpe",			NULL,	60,	0x170,	0x31E,	425000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
	PERIPH_CLK("vcp",	"tegra-avp",		"vcp",	29,	0,	0x31E,	300000000, mux_clk_m, 			0),
	PERIPH_CLK("bsea",	"tegra-avp",		"bsea",	62,	0,	0x31E,	300000000, mux_clk_m, 			0),
	PERIPH_CLK("bsev",	"tegra-aes",		"bsev",	63,	0,	0x31E,  300000000, mux_clk_m, 			0),
...
static struct tegra_sku_rate_limit sku_limits[] =
{
	...
	RATE_LIMIT("3d",	450000000, 0x04, 0x7, 0x08, 0x0F, 0x10),
	RATE_LIMIT("vde",	450000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("3d",	450000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("mpe",       450000000, 0x04, 0x7, 0x08, 0x0F, 0x10),
#else
