...
static const int core_millivolts[MAX_DVFS_FREQS] =
	...
	{950, 1000, 1100, 1200, 1225, 1275, 1300, 1325, 1350};
#else
	{950, 1000, 1100, 1200, 1225, 1275, 1300};
#endif
static const int cpu_millivolts[MAX_DVFS_FREQS] =
#if defined(CONFIG_TEGRA_OVERCLOCK)
	{750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1025, 1175, 1275, 1325, 1350};
#else
...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 380, 380, 503, 503, 655, 655,  798,  798,  902,  960,  1000, 1200, 1408, 1504, 1544),
	CPU_DVFS("cpu", 1, 1, MHZ, 389, 389, 503, 503, 655, 760,  798,  798,  950,  950,  1000, 1200, 1408, 1504, 1544),
	CPU_DVFS("cpu", 1, 2, MHZ, 598, 598, 750, 750, 893, 893,  1000, 1000, 1200, 1200, 1408, 1408, 1408, 1504, 1544 ),
	CPU_DVFS("cpu", 1, 3, MHZ, 730, 760, 845, 845, 940, 1000, 1000, 1200, 1200, 1200, 1408, 1408, 1408, 1504, 1544 ),
#else
