...
#if defined(CONFIG_TEGRA_OVERCLOCK)
	{750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1100, 1200, 1300, 1400, 1425, 1450};
#else
...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 380, 380, 503, 503, 655, 655,  798,  798,  902,  960,  1000, 1200, 1408, 1504, 1600, 1646),
	CPU_DVFS("cpu", 1, 1, MHZ, 389, 389, 503, 503, 655, 760,  798,  798,  950,  950,  1000, 1200, 1408, 1504, 1600, 1646),
	CPU_DVFS("cpu", 1, 2, MHZ, 598, 598, 750, 750, 893, 893,  1000, 1000, 1200, 1200, 1408, 1408, 1408, 1504, 1600, 1646 ),
	CPU_DVFS("cpu", 1, 3, MHZ, 730, 760, 845, 845, 940, 1000, 1000, 1200, 1200, 1200, 1408, 1408, 1408, 1504, 1600, 1646 ),
#else
...
#if defined(CONFIG_TEGRA_OVERCLOCK)
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 300000, 300000, 300000, 320000),
#else
